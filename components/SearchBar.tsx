...
const SearchBar = ({ productData }: any) => {
  ...
  return (
    <div className="h-10 mt-8 mx-24">
      <input
        className="h-full w-full rounded-full px-4 text-black text-base outline-none border-[1px]  focus-visible:border-black duration-200"
        type="text"
